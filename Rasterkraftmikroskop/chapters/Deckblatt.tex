...
\newcommand{\semester}{5,7} %Semester:
\newcommand{\versuch}{Rasterkraftmikroskop} %Versuch:
\newcommand{\nameeins}{Felix Schwarz} %Name1 (Vor und Nachname):
\newcommand{\emaileins}{unuhz@student.kit.edu} %E-Mail 1:
\newcommand{\namezwei}{Karen Granget} %Name2 (Vor und Nachname):
\newcommand{\emailzwei}{usuub@student.kit.edu} %E-Mail 2:
\newcommand{\assistent}{} %Assistent*in:
\newcommand{\durchfuehrungsdatum}{24.01.24} %Durchgeführt am:
